...
routes.patch("/api-trocai/subcategorie/:subcategorie_id", SubCategorieController.patch);
...
routes.patch('/api-trocai/subcategorie/:subcategorie_id/image', SubCategorieImageController.patch)
